...
export const AnalyticsDashboard: React.FC = () => {
  ...
  return (
    <div className="glass-panel p-6 md:p-8 rounded-3xl border border-white/10 shadow-[0_0_50px_rgba(0,240,255,0.05)] h-full flex flex-col relative overflow-hidden font-outfit animate-in fade-in duration-300">
      
      {/* Background Neon Orbs */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-purple-500/10 blur-[100px] -mr-40 -mt-40 rounded-full pointer-events-none"></div>
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-cyan-500/10 blur-[100px] -ml-40 -mb-40 rounded-full pointer-events-none"></div>
      ...
      <div className="relative z-10 flex flex-col h-full overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-4 py-2 bg-white/5 border border-white/10 hover:border-cyan-500/30 text-cyan-400 hover:text-cyan-300 rounded-xl transition-all flex items-center gap-2 text-xs font-bold uppercase tracking-wider"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
          ...
          <div className="glass-panel p-5 rounded-2xl border-white/5 bg-white/5 relative overflow-hidden shadow-lg group hover:scale-[1.02] transition-transform duration-300">
            ...
            <div className="text-[10px] text-cyan-400 font-bold uppercase tracking-wider mt-3 flex items-center gap-1">
          ...
          <div className="glass-panel p-5 rounded-2xl border-white/5 bg-white/5 relative overflow-hidden shadow-lg group hover:scale-[1.02] transition-transform duration-300">
            ...
            <div className="flex items-center justify-between">
              <h3 className={`text-2xl font-black font-mono drop-shadow-md ${scope.profit >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
                Rs. {scope.profit.toLocaleString(undefined, { minimumFractionDigits: 2 })}
              </h3>
              <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${scope.profit >= 0 ? 'bg-emerald-500/10 text-emerald-400' : 'bg-red-500/10 text-red-400'}`}>
                <ArrowUpRight size={16} />
              </div>
            </div>
            <div className={`text-[10px] font-bold uppercase tracking-wider mt-3 flex items-center gap-1 ${scope.profit >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
              ...
              <div>
                ...
                <div className="overflow-y-auto max-h-[110px] pr-2 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
                  <table className="w-full text-left border-collapse text-xs">
                    <thead>
                      <tr className="border-b border-white/5 text-cyan-300/80 font-bold uppercase">
                    ...
                    <tbody className="divide-y divide-white/5">
                      {data.topProducts.map((p, idx) => (
                        <tr key={idx} className="hover:bg-white/5 transition-colors">
                          ...
                          <td className="py-2 px-1 text-right text-emerald-400 font-black">Rs. {p.revenue.toFixed(0)}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
