  ...
  return (
    <div className="px-5 py-3 border-b border-white/5 bg-black/20 flex gap-2 backdrop-blur-sm">
      ...
      <button 
        ...
        className="flex-1 glass-button py-2 rounded-xl text-sm font-bold flex items-center justify-center gap-2 text-cyan-400 disabled:opacity-30 disabled:hover:bg-white/5"
      >
        <Play size={16} /> Resume
      </button>
      <button 
