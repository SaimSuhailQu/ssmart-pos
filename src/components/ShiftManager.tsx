          ...
          <div className="flex justify-between items-center mb-8 border-b border-white/10 pb-6">
            <div>
              <h2 className="text-3xl font-extrabold text-white tracking-tight flex items-center gap-3">
                <Shield className="text-purple-400 drop-shadow-[0_0_8px_rgba(168,85,247,0.4)]" size={32} />
                Staff Dashboard
              </h2>
          ...
          <div className="glass-panel p-6 rounded-2xl border-white/5 bg-white/5 mb-8 flex-1 flex flex-col">
            ...
            <div className="overflow-x-auto overflow-y-auto max-h-[220px] pr-2 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
              <table className="w-full text-left border-collapse text-sm">
                <thead>
                  <tr className="border-b border-white/5 text-cyan-300 font-bold uppercase text-xs">
                            ...
                            {isEditing ? (
                              <>
                                <button
                                  ...
                                  className="p-1.5 bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-400 border border-emerald-500/20 rounded-lg"
                                  title="Save Changes"
                                >
                                  <Check size={16} />
                                </button>
                              ...
                              <>
                                <button
                                  ...
                                  className="p-1.5 bg-cyan-600/20 hover:bg-cyan-600/30 text-cyan-400 border border-cyan-500/20 rounded-lg"
